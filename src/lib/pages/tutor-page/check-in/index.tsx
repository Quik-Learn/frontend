...
import FeedbackModalTutor from '~/lib/components/FeedbackModalTutor';
        ...
        {isLoading ? (
          ...
          >
            <Heading fontSize={'24px'} my={5} color="#161736">
              {session?.has_ended ? 'Session Ended' : 'Check In'}
            </Heading>
            ...
            <Modal
              isOpen={isOpen2 && !session?.has_ended}
              onClose={onClose2}
              isCentered
            >
              <ModalOverlay />
