...
const useHomeMeet = (
  ...
  const [markAttendance, markAttendanceStatus] = useMarkAttendanceMutation();
  ...
  useEffect(() => {
    const statuses = [
      ...
      {
        success: markAttendanceStatus.isSuccess,
        error: markAttendanceStatus.isError,
        // @ts-ignore
        errorMsg: markAttendanceStatus.error?.data?.message,
        successMsg: 'You have successfully marked attendance',
      },
    ];
    ...
    markAttendanceStatus.isSuccess,
  ...
  return {
    ...
    markAttendance,
    isMarkAttendanceLoading: markAttendanceStatus.isLoading,
    elapsedTime,
    remainingTime,
    isTimeUp,
    isNearingEnd,
